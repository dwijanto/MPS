    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If (DirectoryBrowser.ShowDialog() = Windows.Forms.DialogResult.OK) Then
            ...
            Try
                ...
                'add datafield
                oSheet.PivotTables("PivotTable1").AddDataField(oSheet.PivotTables("PivotTable1").PivotFields("OrderConfirmed"), "Sum of OrderConfirmed", Excel.XlConsolidationFunction.xlSum)
                oSheet.PivotTables("PivotTable1").AddDataField(oSheet.PivotTables("PivotTable1").PivotFields("OrderUnconfirmed"), "Sum of OrderUnConfirmed", Excel.XlConsolidationFunction.xlSum)
