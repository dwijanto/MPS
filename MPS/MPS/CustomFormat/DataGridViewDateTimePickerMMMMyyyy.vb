...
Public Class CalendarColumn1
    ...
    Public Overrides Function Clone() As Object
        Dim col As CalendarColumn1 = DirectCast(MyBase.Clone(), CalendarColumn1)
        col.ShowCheckBox = Me.ShowCheckBox
        col.CustomFormat = Me.CustomFormat
...
Public Class CalendarCell1
    ...
    Public Overrides Sub InitializeEditingControl(ByVal rowIndex As Integer, _
        ...
        '***************
        ctl.ShowCheckBox = TryCast(Me.DataGridView.Columns(Me.ColumnIndex), CalendarColumn1).ShowCheckBox
        ctl.CustomFormat = TryCast(Me.DataGridView.Columns(Me.ColumnIndex), CalendarColumn1).CustomFormat
        Me.Style.Format = TryCast(Me.DataGridView.Columns(Me.ColumnIndex), CalendarColumn1).Format
