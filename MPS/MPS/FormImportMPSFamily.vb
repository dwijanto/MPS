...
Imports Npgsql
Imports System.Text
Public Class FormImportMPSFamily
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        FormMenu.setBubbleMessage("Import MPS Family", "Done")
        If Status Then
    ...
    Private Function ImportData(ByVal FileName As String, Optional ByRef errMessage As String = "") As Boolean
        ...
        Try
            ...
            'sqlstr = "select cmmf,mpsfamilyid from sspcmmfmps;"
            ...
            'Dataset1.Tables(0).TableName = "MPS"
            ...
            For i = 1 To list.Count - 1
                Try
                    ...
                    If myRecord(0) <> "" Then
                        Try
                            'myhashtable.Add(myRecord(0).ToString, myRecord(0).ToString & "," & myRecord(1).ToString)
                            ...
                            mySB.Append(myRecord(0) & vbTab)
                            mySB.Append(myRecord(1) & vbCrLf)
                            'End If
                        Catch ex As Exception
            ...
            errMessage = dbtools1.ExecuteNonQuery("delete from cmmfsopmps;")

            sqlstr = "copy cmmfsopmps(cmmf,mpsfamily) from stdin;"
            BackgroundWorker1.ReportProgress(2, "Copy To Db (MPS Family)")
